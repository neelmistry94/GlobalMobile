...
// in simulator we redefine to format for Hello Developer console
...
{\
	NSString * exceptionName = [@"org.hello." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hello";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHelloNativeItemNone = -1, 
	UIHelloNativeItemSpinner = -2,
	UIHelloNativeItemProgressBar = -3,
	
	UIHelloNativeItemSlider = -4,
	UIHelloNativeItemSwitch = -5,
	UIHelloNativeItemMultiButton = -6,
	UIHelloNativeItemSegmented = -7,
	
	UIHelloNativeItemTextView = -8,
	UIHelloNativeItemTextField = -9,
	UIHelloNativeItemSearchBar = -10,
	
	UIHelloNativeItemPicker = -11,
	UIHelloNativeItemDatePicker = -12,
	
	UIHelloNativeItemInfoLight = -13,
	UIHelloNativeItemInfoDark = -14,
	
	UIHelloNativeItemDisclosure = -15,
	
	UIHelloNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hello instances of
